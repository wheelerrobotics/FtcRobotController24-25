        ...
        Actions.runBlocking(
                new ParallelAction(
                        new SequentialAction(
                                ...
                                new ParallelAction(
                                        bucket0, hob.actionMacroTimeout(SLIDES_DEPOSIT, 500)),

                                new ParallelAction(
                                        pickup1, hob.actionMacro(EXTENDO_CLAW_OVER_SAMPLE_AUTO)),
                                hob.actionMacro(EXTENDO_CLAW_BEFORE_PICKUP),

                                new ParallelAction(
                                        bucket1, new ParallelAction(hob.actionMacro(FULL_TRANSFER), hob.actionWait(1000),  hob.actionMacro(SLIDES_DEPOSIT))),

                                new ParallelAction(
                                        pickup2, hob.actionMacro(EXTENDO_CLAW_OVER_SAMPLE_AUTO)),
                                hob.actionMacro(EXTENDO_CLAW_BEFORE_PICKUP),

                                new ParallelAction(
                                        bucket2, new ParallelAction(hob.actionMacro(FULL_TRANSFER), hob.actionWait(1000),  hob.actionMacro(SLIDES_DEPOSIT))),

                                new ParallelAction(
                                        pickup3, hob.actionMacro(EXTENDO_CLAW_OVER_SAMPLE_AUTO)),
                                hob.actionMacro(EXTENDO_CLAW_BEFORE_PICKUP),
                                ...
                                new ParallelAction(
                                        park, hob.actionMacroTimeout(IN_NO_TRANSFER, 1500)),
