...
@Autonomous(name = "1 + 2 Specimen Side")
public class OnePlusTwoSpecimen extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        TrajectoryActionBuilder a4 = a2.endTrajectory().fresh().setTangent(-PI / 4)
