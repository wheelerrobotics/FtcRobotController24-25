...
public class MecanumDrive {
    public static class Params {
        ...
        public double inPerTick = .99268547544; // If you're using OTOS/Pinpoint leave this at 1 (all values will be in inches, 1 tick = 1 inch)
        public double lateralInPerTick = 0.6009601; // Tune this with LateralRampLogger (even if you use OTOS/Pinpoint)
        public double trackWidthTicks = 9.361519109861067;

        // feedforward parameters (in tick units)
        public double kS = 1.27;
        public double kV = 0.146;
        public double kA = 0;
