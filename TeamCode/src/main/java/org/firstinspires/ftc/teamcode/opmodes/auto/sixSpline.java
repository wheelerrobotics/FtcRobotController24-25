...
@Autonomous
public class sixSpline extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        TrajectoryActionBuilder a1_5 = a1.endTrajectory().fresh().setTangent(0)
                ...
                .setReversed(true)
                .splineTo(new Vector2d(7,-31),PI,
                        null, new ProfileAccelConstraint(-80, 80))
                .splineTo(new Vector2d(0,-31),PI,
                        null, new ProfileAccelConstraint(-50, 80))
                ;
                ...
                new ParallelAction(
                        new SequentialAction(
                             ...
                             //   raz.actionLimelight(1000),
                                ...
                                new ParallelAction(
                                        raz.actionMacroTimeout(DROP,1000),
                                        drop
                                ),
                                ...
                                new ParallelAction(
                                        raz.actionMacroTimeout(SWEEP_DOWN,1200),
                                        beforeSweep1
                                ),
