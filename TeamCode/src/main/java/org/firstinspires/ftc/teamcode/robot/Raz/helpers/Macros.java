...
public class Macros {
    ...
    public static RazState AUTO_START = new RazState(DEPOSIT_SWIVEL_SPEC_PICKUP, DEPOSIT_ARM_SPEC_PICKUP,
            DEPOSIT_CLAW_CLOSED, DEPOSIT_WRIST_SPEC_PICKUP, EXTENDO_START, TURRET_NEUTRAL,
