...
import static org.firstinspires.ftc.teamcode.robot.Hobbes.helpers.Macros.SPECIMEN_BEFORE_DEPOSIT;
import static org.firstinspires.ftc.teamcode.robot.Hobbes.helpers.Macros.SPECIMEN_BEFORE_PICKUP;
import static org.firstinspires.ftc.teamcode.robot.Hobbes.helpers.Macros.SPECIMEN_DEPOSIT_AND_RESET;
import static org.firstinspires.ftc.teamcode.robot.Hobbes.helpers.Macros.SPECIMEN_PICKUP_AND_BEFORE_DEPOSIT;
        ...
        Actions.runBlocking(
                new ParallelAction(
                        new SequentialAction(
                                ...
                                drive.actionBuilder(new Pose2d(35,63,PI)).setTangent(0).splineToConstantHeading(new Vector2d(50, 60), 0).build(),
                                ...
                                drive.actionBuilder(drive.pose).setTangent(-PI/2).splineToLinearHeading(new Pose2d(48, 44, -PI/2), -PI/2).build(),
