...
@Autonomous
public class fie extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        TrajectoryActionBuilder a3 = a2.endTrajectory().fresh()
                .setTangent(PI).splineToLinearHeading(new Pose2d(21, -7, -PI/2+-PI/5.5),
                        0, null, new ProfileAccelConstraint(-20, 20));

        //second sweep
        TrajectoryActionBuilder s2 = a3.endTrajectory().fresh()
                .setTangent(0)
                .splineToLinearHeading(new Pose2d(28, -25, -PI/3), -PI * 5 / 6,  null, new ProfileAccelConstraint(-40, 30));
        ...
        TrajectoryActionBuilder s4 = s3.endTrajectory().fresh()
                .setTangent(0)
                .splineToLinearHeading(new Pose2d(35, -31, -PI/3), -PI * 4 / 6,  null, new ProfileAccelConstraint(-40, 30));

        TrajectoryActionBuilder s4_5 = s4.endTrajectory().fresh()
                .setTangent(-PI/4).splineToLinearHeading(new Pose2d(30, -26, -PI/2+-PI/4),
                        PI,  null, new ProfileAccelConstraint(-20, 20));
