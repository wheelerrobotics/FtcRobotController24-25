...
public class AaronSickAuto extends LinearOpMode {
    // 1+4 specimen, new code for getting fifth specimen properly
    Hobbes hob = null;
    PinpointDrive drive;
    ...
    public void runOpMode() {
        ...
        //this is really bad. put it in meep meep.

        TrajectoryActionBuilder s4 = s3.endTrajectory().fresh().splineTo(new Vector2d(-19, 44), 2.5);
        TrajectoryActionBuilder s5 = s4.endTrajectory().fresh().fresh().splineTo(new Vector2d(-19, 35), 3*PI/16);
        ...
        TrajectoryActionBuilder a11 = a9.endTrajectory().fresh().setTangent(0)
                .splineToSplineHeading(new Pose2d(-20, 32.5, PI), 0)
                .splineToSplineHeading(new Pose2d(-1.5, 33, PI), 0, null, new ProfileAccelConstraint(-10, 10));
        TrajectoryActionBuilder a12 = a11.endTrajectory().fresh().setTangent(PI)
