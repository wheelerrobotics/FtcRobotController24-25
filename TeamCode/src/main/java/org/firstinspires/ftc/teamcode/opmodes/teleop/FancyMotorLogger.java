...
@TeleOp
public class FancyMotorLogger extends OpMode {
    ...
    public void loop() {
        tele.addData("mA", hob.slides.getCurrent(CurrentUnit.MILLIAMPS));
        tele.addData("vel˚", hob.slides.getVelocity(AngleUnit.DEGREES));
        tele.update();
