...
@Autonomous
public class FiveSpecSplines extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        TrajectoryActionBuilder s4_5_5 = s4_5.endTrajectory().fresh()
                .splineToLinearHeading(new Pose2d(-1, -29, 0), PI,
                        null, new ProfileAccelConstraint(-10, 30));
        ...
        TrajectoryActionBuilder a5 = s4_5_5.endTrajectory().fresh()
                ...
                .splineToConstantHeading(new Vector2d(37, 5), 0,
                        null, new ProfileAccelConstraint(-60, 20));
        ...
        TrajectoryActionBuilder a6 = a5.endTrajectory().fresh()
                ...
                .lineToX(0,
                        null, new ProfileAccelConstraint(-40, 30));
        ...
        TrajectoryActionBuilder a7 = a6.endTrajectory().fresh()
                ...
                .setReversed(true)
                .setTangent(PI/4 + PI/20)
                .splineToConstantHeading(new Vector2d(37, 6), 0,
                        null, new ProfileAccelConstraint(-60, 30));
        ...
        TrajectoryActionBuilder a9 = a8.endTrajectory().fresh()
                ...
                .setReversed(true)
                .setTangent(PI/4 + PI/20)
                .splineToConstantHeading(new Vector2d(37, 7), 0,
                        null, new ProfileAccelConstraint(-60, 30));
        ...
        TrajectoryActionBuilder a11 = a10.endTrajectory().fresh()
                ...
                .setReversed(true)
                .setTangent(PI/4 + PI/20)
                .splineToConstantHeading(new Vector2d(37, 8), 0,
                        null, new ProfileAccelConstraint(-40, 30));
        ...
        Actions.runBlocking(
                new ParallelAction(
                        new SequentialAction(
                                raz.actionMacroTimeout(SPEC_TO_DEPOSIT, 200),
                                specimen1,
                                raz.actionWait(100),
