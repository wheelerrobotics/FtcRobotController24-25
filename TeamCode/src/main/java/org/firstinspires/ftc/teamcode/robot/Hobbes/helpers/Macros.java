...
public class Macros {
    ...
    public static HobbesState FULL_TRANSFER4 = new HobbesState(EXTENDO_TRANSFER, EXTENDO_ARM_TRANSFER, EXTENDO_WRIST_TRANSFER, SLIDES_ARM_TRANSFER, SLIDES_WRIST_TRANSFER, EXTENDO_CLAW_CLOSED, CLAW_OPEN, SLIDES_IN, null, SWIVEL_STRAIGHT, null);
    ...
    public static HobbesState FULL_TRANSFER1_5 = new HobbesState(EXTENDO_MOSTLY_TRANSFER, EXTENDO_ARM_TRANSFER, EXTENDO_WRIST_TRANSFER, SLIDES_ARM_TRANSFER, SLIDES_WRIST_TRANSFER, EXTENDO_CLAW_CLOSED, CLAW_OPEN, SLIDES_IN, null, SWIVEL_STRAIGHT, new LinkedState(FULL_TRANSFER2, 600));
    public static HobbesState FULL_TRANSFER = new HobbesState(EXTENDO_MOSTLY_TRANSFER, EXTENDO_ARM_ABOVE_SUB_BARRIER, EXTENDO_WRIST_CHAMBER_TRANSFER, SLIDES_ARM_TRANSFER, SLIDES_WRIST_TRANSFER, EXTENDO_CLAW_CLOSED, CLAW_OPEN, SLIDES_IN, null, SWIVEL_STRAIGHT, new LinkedState(FULL_TRANSFER1_5, 500));
    ...
    public static HobbesState SAMPLE_SWEEP_UP = new HobbesState(EXTENDO_OUT_FULL, EXTENDO_ARM_PUSH_UP,
            EXTENDO_WRIST_INTAKE_FLAT, SLIDES_ARM_ABOVE_TRANSFER, SLIDES_WRIST_TRANSFER, EXTENDO_CLAW_SWEEP, null, 0,  null,SWIVEL_TRANSFER_IP+.06,null);
