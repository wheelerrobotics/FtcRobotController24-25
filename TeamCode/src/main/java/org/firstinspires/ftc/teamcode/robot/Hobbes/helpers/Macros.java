...
public class Macros {
    ...
    public static HobbesState FULL_TRANSFER2 = new HobbesState(EXTENDO_TRANSFER, EXTENDO_ARM_TRANSFER, EXTENDO_WRIST_TRANSFER, SLIDES_ARM_TRANSFER, SLIDES_WRIST_TRANSFER, EXTENDO_CLAW_CLOSED, CLAW_OPEN, SLIDES_IN, null, SWIVEL_STRAIGHT, new LinkedState(FULL_TRANSFER3, 600));
