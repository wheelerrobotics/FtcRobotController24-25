...
public class Macros {
    ...
    public static HobbesState FULL_TRANSFER_AUTO5 = new HobbesState(EXTENDO_MOSTLY_TRANSFER, EXTENDO_ARM_TRANSFER_SPEC, EXTENDO_WRIST_TRANSFER_SPEC, SLIDES_ARM_TRANSFER_SPEC, SLIDES_WRIST_TRANSFER_SPEC, CLAW_OPEN, CLAW_CLOSED, SLIDES_IN, null, SWIVEL_STRAIGHT_SPEC, new LinkedState(STUPID_SPECIMEN_TO_DEPOSIT_NEW, 20));
    public static HobbesState FULL_TRANSFER_AUTO4 = new HobbesState(EXTENDO_TRANSFER_IP, EXTENDO_ARM_TRANSFER_SPEC, EXTENDO_WRIST_TRANSFER_SPEC, SLIDES_ARM_TRANSFER_SPEC, SLIDES_WRIST_TRANSFER_SPEC, CLAW_OPEN, CLAW_CLOSED, SLIDES_IN, null, SWIVEL_STRAIGHT_SPEC, new LinkedState(FULL_TRANSFER_AUTO5, 20));
    ...
    public static HobbesState FULL_TRANSFER_AUTO_OLD = new HobbesState(EXTENDO_IN, EXTENDO_ARM_SPECIMEN_PICKUP, EXTENDO_WRIST_SPECIMEN_PICKED_UP, SLIDES_ARM_TRANSFER_SPEC, SLIDES_WRIST_TRANSFER_SPEC, CLAW_ALMOST_CLOSED, CLAW_OPEN, SLIDES_IN, null, SWIVEL_STRAIGHT, new LinkedState(FULL_TRANSFER_AUTO_52, 100));
    public static HobbesState FULL_TRANSFER_AUTO = new HobbesState(EXTENDO_IN, EXTENDO_ARM_SPECIMEN_PICKUP, EXTENDO_WRIST_SPECIMEN_PICKUP, SLIDES_ARM_TRANSFER_SPEC, SLIDES_WRIST_TRANSFER_SPEC, CLAW_ALMOST_CLOSED, CLAW_OPEN, SLIDES_IN, null, SWIVEL_STRAIGHT, new LinkedState(FULL_TRANSFER_AUTO_OLD, 100));
    ...
    public static HobbesState TELE_SPECIMEN_PICKUP = new HobbesState(EXTENDO_IN, EXTENDO_ARM_SPECIMEN_PICKUP, EXTENDO_WRIST_SPECIMEN_PICKUP,
            ...
            null,SWIVEL_STRAIGHT,null);
    public static HobbesState SPEC_ALMOST_PICKUP = new HobbesState(EXTENDO_IN, EXTENDO_ARM_SPECIMEN_PICKUP+.025, EXTENDO_WRIST_SPECIMEN_PICKUP,
            SLIDES_ARM_ABOVE_TRANSFER, SLIDES_WRIST_TRANSFER, EXTENDO_CLAW_OPEN, CLAW_OPEN, SLIDES_IN,
            null,SWIVEL_STRAIGHT,null);
