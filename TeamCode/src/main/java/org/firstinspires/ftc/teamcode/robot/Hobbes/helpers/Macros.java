...
public class Macros {
    ...
    public static HobbesState SLIDES_DOWN_AUTO = new HobbesState(null, null, null, SLIDES_ARM_ABOVE_TRANSFER,
            .7, null, CLAW_OPEN, SLIDES_IN,  null,null,null);
    ...
    public static HobbesState SPECIMEN_BEFORE_PICKUP_last = new HobbesState(EXTENDO_OUT_FULL, EXTENDO_ARM_PUSH_DOWN, EXTENDO_WRIST_INTAKE_FLAT, SLIDES_ARM_ABOVE_TRANSFER,
            .7, null, CLAW_OPEN, SLIDES_SPECIMEN_TO_PICKUP,  null,SWIVEL_STRAIGHT,null);
    ...
    public static HobbesState BACKUP_SPEC_PICKUP = new HobbesState(null, null, null, SLIDES_ARM_PICKUP_BACKUP,
            SLIDES_WRIST_PICKUP_BACKUP, null, CLAW_OPEN, SLIDES_IN,  null,null,new LinkedState(STUPID_SPECIMEN_TO_DEPOSIT_NEW, 20));
