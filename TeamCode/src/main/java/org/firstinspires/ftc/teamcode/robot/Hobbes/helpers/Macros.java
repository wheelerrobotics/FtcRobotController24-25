...
public class Macros {
    ...
    public static HobbesState EXTENDO_CLAW_BEFORE_PICKUP = new HobbesState(null, EXTENDO_ARM_PICKUP, EXTENDO_WRIST_PICKUP, null, null, CLAW_OPEN, null, null, null,null, null);
    public static HobbesState EXTENDO_CLAW_BEFORE_PICKUP_INSIDE = new HobbesState(null, EXTENDO_ARM_PICKUP, EXTENDO_WRIST_PICKUP, null, null, CLAW_CLOSED, null, null, null,null, null);
    ...
    public static HobbesState FULL_TRANSFER_AUTO5 = new HobbesState(EXTENDO_MOSTLY_TRANSFER, EXTENDO_ARM_TRANSFER, EXTENDO_WRIST_TRANSFER, SLIDES_ARM_TRANSFER, SLIDES_WRIST_TRANSFER, CLAW_OPEN, CLAW_CLOSED, SLIDES_IN, null, SWIVEL_TRANSFER, new LinkedState(STUPID_SPECIMEN_TO_DEPOSIT_NEW, 700));
    public static HobbesState FULL_TRANSFER_AUTO4 = new HobbesState(EXTENDO_TRANSFER, EXTENDO_ARM_TRANSFER, EXTENDO_WRIST_TRANSFER, SLIDES_ARM_TRANSFER, SLIDES_WRIST_TRANSFER, CLAW_OPEN, CLAW_CLOSED, SLIDES_IN, null, SWIVEL_TRANSFER, new LinkedState(FULL_TRANSFER_AUTO5, 50));
    public static HobbesState FULL_TRANSFER_AUTO3 = new HobbesState(EXTENDO_TRANSFER, EXTENDO_ARM_TRANSFER, EXTENDO_WRIST_TRANSFER, SLIDES_ARM_TRANSFER, SLIDES_WRIST_TRANSFER, CLAW_CLOSED, CLAW_CLOSED, SLIDES_IN, null, SWIVEL_TRANSFER, new LinkedState(FULL_TRANSFER_AUTO4, 50));
    public static HobbesState FULL_TRANSFER_AUTO2 = new HobbesState(EXTENDO_TRANSFER, EXTENDO_ARM_TRANSFER, EXTENDO_WRIST_TRANSFER, SLIDES_ARM_TRANSFER, SLIDES_WRIST_TRANSFER, CLAW_CLOSED, CLAW_OPEN, SLIDES_IN, null, SWIVEL_TRANSFER, new LinkedState(FULL_TRANSFER_AUTO3, 50));
    public static HobbesState FULL_TRANSFER_AUTO = new HobbesState(EXTENDO_MOSTLY_TRANSFER, EXTENDO_ARM_TRANSFER, EXTENDO_WRIST_TRANSFER, SLIDES_ARM_TRANSFER, SLIDES_WRIST_TRANSFER, CLAW_CLOSED, CLAW_OPEN, SLIDES_IN, null, SWIVEL_TRANSFER, new LinkedState(FULL_TRANSFER_AUTO2, 500));
    ...
    public static HobbesState FULL_TRANSFER3 = new HobbesState(EXTENDO_TRANSFER, EXTENDO_ARM_TRANSFER, EXTENDO_WRIST_TRANSFER, SLIDES_ARM_TRANSFER, SLIDES_WRIST_TRANSFER, CLAW_CLOSED, CLAW_CLOSED, SLIDES_IN, null, SWIVEL_TRANSFER, new LinkedState(FULL_TRANSFER4, 50));
    public static HobbesState FULL_TRANSFER2 = new HobbesState(EXTENDO_TRANSFER, EXTENDO_ARM_TRANSFER, EXTENDO_WRIST_TRANSFER, SLIDES_ARM_TRANSFER, SLIDES_WRIST_TRANSFER, CLAW_CLOSED, CLAW_OPEN, SLIDES_IN, null, SWIVEL_TRANSFER, new LinkedState(FULL_TRANSFER3, 50));
    public static HobbesState FULL_TRANSFER = new HobbesState(EXTENDO_MOSTLY_TRANSFER, EXTENDO_ARM_TRANSFER, EXTENDO_WRIST_TRANSFER, SLIDES_ARM_TRANSFER, SLIDES_WRIST_TRANSFER, CLAW_CLOSED, CLAW_OPEN, SLIDES_IN, null, SWIVEL_TRANSFER, new LinkedState(FULL_TRANSFER2, 500));

    public static HobbesState FULL_TRANSFER_IP5 = new HobbesState(EXTENDO_MOSTLY_TRANSFER_IP, EXTENDO_ARM_TRANSFER, EXTENDO_WRIST_TRANSFER, SLIDES_ARM_TRANSFER, SLIDES_WRIST_TRANSFER, CLAW_CLOSED, CLAW_CLOSED, SLIDES_IN, null, SWIVEL_TRANSFER_IP, null);
    public static HobbesState FULL_TRANSFER_IP4 = new HobbesState(EXTENDO_TRANSFER_IP, EXTENDO_ARM_TRANSFER, EXTENDO_WRIST_TRANSFER, SLIDES_ARM_TRANSFER, SLIDES_WRIST_TRANSFER, CLAW_CLOSED, CLAW_CLOSED, SLIDES_IN, null, SWIVEL_TRANSFER_IP, new LinkedState(FULL_TRANSFER_IP5, 50));
    public static HobbesState FULL_TRANSFER_IP3 = new HobbesState(EXTENDO_TRANSFER_IP, EXTENDO_ARM_TRANSFER, EXTENDO_WRIST_TRANSFER, SLIDES_ARM_TRANSFER, SLIDES_WRIST_TRANSFER, EXTENDO_CLAW_IP, CLAW_CLOSED, SLIDES_IN, null, SWIVEL_TRANSFER_IP, new LinkedState(FULL_TRANSFER_IP4, 50));
    public static HobbesState FULL_TRANSFER_IP2 = new HobbesState(EXTENDO_TRANSFER_IP, EXTENDO_ARM_TRANSFER, EXTENDO_WRIST_TRANSFER, SLIDES_ARM_TRANSFER, SLIDES_WRIST_TRANSFER, EXTENDO_CLAW_IP, CLAW_OPEN, SLIDES_IN, null, SWIVEL_TRANSFER_IP, new LinkedState(FULL_TRANSFER_IP3, 50));
    public static HobbesState FULL_TRANSFER_IP = new HobbesState(EXTENDO_MOSTLY_TRANSFER_IP, EXTENDO_ARM_TRANSFER, EXTENDO_WRIST_TRANSFER, SLIDES_ARM_TRANSFER, SLIDES_WRIST_TRANSFER, EXTENDO_CLAW_IP, CLAW_OPEN, SLIDES_IN, null, SWIVEL_TRANSFER_IP, new LinkedState(FULL_TRANSFER_IP2, 500));
    ...
    public static HobbesState SPEC_AUTO_PARK = new HobbesState(EXTENDO_OUT_SOME, EXTENDO_ARM_INTAKE,
            EXTENDO_WRIST_INTAKE_FLAT, null, null, null, null, SLIDES_IN,  null,null,null);
