...
public class Macros {
    ...
    public static HobbesState EXTENDO_CLAW_BEFORE_PICKUP5 = new HobbesState(null, EXTENDO_ARM_ABOVE_PICKUP, EXTENDO_WRIST_PICKUP, null, null, EXTENDO_CLAW_CLOSED, null, null, null,SWIVEL_STRAIGHT, null);
    public static HobbesState EXTENDO_CLAW_BEFORE_PICKUP4 = new HobbesState(null, EXTENDO_ARM_ABOVE_PICKUP, EXTENDO_WRIST_PICKUP, null, null, CLAW_ALMOST_CLOSED, null, null, null,SWIVEL_STRAIGHT, new LinkedState(EXTENDO_CLAW_BEFORE_PICKUP5, 300));
    public static HobbesState EXTENDO_CLAW_BEFORE_PICKUP3 = new HobbesState(null, EXTENDO_ARM_ABOVE_PICKUP, EXTENDO_WRIST_PICKUP, null, null, EXTENDO_CLAW_CLOSED, null, null, null,null, new LinkedState(EXTENDO_CLAW_BEFORE_PICKUP4, 10));
    public static HobbesState EXTENDO_CLAW_BEFORE_PICKUP2 = new HobbesState(null, EXTENDO_ARM_PICKUP, EXTENDO_WRIST_PICKUP, null, null, EXTENDO_CLAW_CLOSED, null, null, null,null, new LinkedState(EXTENDO_CLAW_BEFORE_PICKUP3, 10));
    public static HobbesState EXTENDO_CLAW_BEFORE_PICKUP = new HobbesState(null, EXTENDO_ARM_PICKUP, EXTENDO_WRIST_PICKUP, null, null, EXTENDO_CLAW_OPEN, null, null, null,null, new LinkedState(EXTENDO_CLAW_BEFORE_PICKUP2, 10));
    ...
    public static HobbesState FULL_TRANSFER_AUTO4 = new HobbesState(EXTENDO_TRANSFER_IP, EXTENDO_ARM_TRANSFER_SPEC, EXTENDO_WRIST_TRANSFER_SPEC, SLIDES_ARM_TRANSFER_SPEC, SLIDES_WRIST_TRANSFER_SPEC, CLAW_OPEN, CLAW_CLOSED, SLIDES_IN, null, SWIVEL_STRAIGHT_SPEC, new LinkedState(FULL_TRANSFER_AUTO5, 100));
    ...
    public static HobbesState FULL_TRANSFER_AUTO1_5 = new HobbesState(EXTENDO_MOSTLY_TRANSFER, EXTENDO_ARM_TRANSFER_SPEC, EXTENDO_WRIST_TRANSFER_SPEC, SLIDES_ARM_TRANSFER_SPEC, SLIDES_WRIST_TRANSFER_SPEC, EXTENDO_CLAW_CLOSED, CLAW_OPEN, SLIDES_IN, null, SWIVEL_STRAIGHT_SPEC, new LinkedState(FULL_TRANSFER_AUTO2, 300));
    ...
    public static HobbesState FULL_TRANSFER_AUTO_52 = new HobbesState(EXTENDO_IN, EXTENDO_ARM_SPECIMEN_PICKUP, EXTENDO_WRIST_SPECIMEN_PICKED_UP, SLIDES_ARM_TRANSFER_SPEC, SLIDES_WRIST_TRANSFER_SPEC, CLAW_ALMOST_CLOSED, CLAW_OPEN, SLIDES_IN, null, SWIVEL_STRAIGHT, new LinkedState(FULL_TRANSFER_AUTO_5, 100));
    public static HobbesState FULL_TRANSFER_AUTO = new HobbesState(EXTENDO_IN, EXTENDO_ARM_SPECIMEN_PICKUP, EXTENDO_WRIST_SPECIMEN_PICKED_UP, SLIDES_ARM_TRANSFER_SPEC, SLIDES_WRIST_TRANSFER_SPEC, EXTENDO_CLAW_CLOSED, CLAW_OPEN, SLIDES_IN, null, SWIVEL_STRAIGHT, new LinkedState(FULL_TRANSFER_AUTO_52, 100));


    public static HobbesState FULL_TRANSFER5 = new HobbesState(EXTENDO_MOSTLY_TRANSFER, EXTENDO_ARM_TRANSFER, EXTENDO_WRIST_TRANSFER, SLIDES_ARM_TRANSFER, SLIDES_WRIST_TRANSFER, CLAW_OPEN, CLAW_CLOSED, SLIDES_IN, null, SWIVEL_TRANSFER, null);
    public static HobbesState FULL_TRANSFER4 = new HobbesState(EXTENDO_TRANSFER, EXTENDO_ARM_TRANSFER, EXTENDO_WRIST_TRANSFER, SLIDES_ARM_TRANSFER, SLIDES_WRIST_TRANSFER, CLAW_OPEN, CLAW_CLOSED, SLIDES_IN, null, SWIVEL_TRANSFER, new LinkedState(FULL_TRANSFER5, 50));
    public static HobbesState FULL_TRANSFER3 = new HobbesState(EXTENDO_TRANSFER, EXTENDO_ARM_TRANSFER, EXTENDO_WRIST_TRANSFER, SLIDES_ARM_TRANSFER, SLIDES_WRIST_TRANSFER, EXTENDO_CLAW_CLOSED, CLAW_CLOSED, SLIDES_IN, null, SWIVEL_TRANSFER, new LinkedState(FULL_TRANSFER4, 50));
    public static HobbesState FULL_TRANSFER2 = new HobbesState(EXTENDO_TRANSFER, EXTENDO_ARM_TRANSFER, EXTENDO_WRIST_TRANSFER, SLIDES_ARM_TRANSFER, SLIDES_WRIST_TRANSFER, EXTENDO_CLAW_CLOSED, CLAW_OPEN, SLIDES_IN, null, SWIVEL_TRANSFER, new LinkedState(FULL_TRANSFER3, 600));
    public static HobbesState FULL_TRANSFER1_5 = new HobbesState(EXTENDO_MOSTLY_TRANSFER, EXTENDO_ARM_TRANSFER, EXTENDO_WRIST_TRANSFER, SLIDES_ARM_TRANSFER, SLIDES_WRIST_TRANSFER, EXTENDO_CLAW_CLOSED, CLAW_OPEN, SLIDES_IN, null, SWIVEL_TRANSFER, new LinkedState(FULL_TRANSFER2, 800));
