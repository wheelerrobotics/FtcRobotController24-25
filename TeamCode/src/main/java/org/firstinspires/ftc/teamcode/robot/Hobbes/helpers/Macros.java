...
public class Macros {
    ...
    public static HobbesState EXTENDO_CLAW_OVER_SAMPLE = new HobbesState(null, EXTENDO_ARM_ABOVE_PICKUP, EXTENDO_WRIST_PICKUP, null, null, CLAW_OPEN, null, null, null, null, null);
    ...
    public static HobbesState EXTENDO_CLAW_BEFORE_PICKUP2 = new HobbesState(null, EXTENDO_ARM_PICKUP, EXTENDO_WRIST_PICKUP, null, null, EXTENDO_CLAW_CLOSED, null, null, null,null, new LinkedState(EXTENDO_CLAW_BEFORE_PICKUP3, 200));
    public static HobbesState EXTENDO_CLAW_BEFORE_PICKUP = new HobbesState(null, EXTENDO_ARM_PICKUP, EXTENDO_WRIST_PICKUP, null, null, EXTENDO_CLAW_OPEN, null, null, null,null, new LinkedState(EXTENDO_CLAW_BEFORE_PICKUP2, 200));
    ...
    public static HobbesState EXTENDO_CLAW_BEFORE_PICKUP_INSIDE2 = new HobbesState(null, EXTENDO_ARM_PICKUP, EXTENDO_WRIST_PICKUP, null, null, EXTENDO_CLAW_IP, null, null, null,null, new LinkedState(EXTENDO_CLAW_BEFORE_PICKUP_INSIDE3, 200));
    public static HobbesState EXTENDO_CLAW_BEFORE_PICKUP_INSIDE = new HobbesState(null, EXTENDO_ARM_PICKUP, EXTENDO_WRIST_PICKUP, null, null, EXTENDO_CLAW_OPEN, null, null, null,null, new LinkedState(EXTENDO_CLAW_BEFORE_PICKUP_INSIDE2, 200));
    ...
    public static HobbesState FULL_TRANSFER_AUTO5 = new HobbesState(EXTENDO_MOSTLY_TRANSFER, EXTENDO_ARM_TRANSFER_SPEC, EXTENDO_WRIST_TRANSFER_SPEC, SLIDES_ARM_TRANSFER_SPEC, SLIDES_WRIST_TRANSFER_SPEC, CLAW_OPEN, CLAW_CLOSED, SLIDES_IN, null, SWIVEL_STRAIGHT, new LinkedState(STUPID_SPECIMEN_TO_DEPOSIT_NEW, 100));
    public static HobbesState FULL_TRANSFER_AUTO4 = new HobbesState(EXTENDO_TRANSFER_IP, EXTENDO_ARM_TRANSFER_SPEC, EXTENDO_WRIST_TRANSFER_SPEC, SLIDES_ARM_TRANSFER_SPEC, SLIDES_WRIST_TRANSFER_SPEC, CLAW_OPEN, CLAW_CLOSED, SLIDES_IN, null, SWIVEL_STRAIGHT, new LinkedState(FULL_TRANSFER_AUTO5, 100));
    public static HobbesState FULL_TRANSFER_AUTO3 = new HobbesState(EXTENDO_TRANSFER_IP, EXTENDO_ARM_TRANSFER_SPEC, EXTENDO_WRIST_TRANSFER_SPEC, SLIDES_ARM_TRANSFER_SPEC, SLIDES_WRIST_TRANSFER_SPEC, EXTENDO_CLAW_CLOSED, CLAW_CLOSED, SLIDES_IN, null, SWIVEL_STRAIGHT, new LinkedState(FULL_TRANSFER_AUTO4, 100));
    public static HobbesState FULL_TRANSFER_AUTO2 = new HobbesState(EXTENDO_TRANSFER_IP, EXTENDO_ARM_TRANSFER_SPEC, EXTENDO_WRIST_TRANSFER_SPEC, SLIDES_ARM_TRANSFER_SPEC, SLIDES_WRIST_TRANSFER_SPEC, EXTENDO_CLAW_CLOSED, CLAW_OPEN, SLIDES_IN, null, SWIVEL_STRAIGHT, new LinkedState(FULL_TRANSFER_AUTO3, 500));
    public static HobbesState FULL_TRANSFER_AUTO1_5 = new HobbesState(EXTENDO_MOSTLY_TRANSFER, EXTENDO_ARM_TRANSFER_SPEC, EXTENDO_WRIST_TRANSFER_SPEC, SLIDES_ARM_TRANSFER_SPEC, SLIDES_WRIST_TRANSFER_SPEC, EXTENDO_CLAW_CLOSED, CLAW_OPEN, SLIDES_IN, null, SWIVEL_STRAIGHT, new LinkedState(FULL_TRANSFER_AUTO2, 500));
    public static HobbesState FULL_TRANSFER_AUTO_5 = new HobbesState(EXTENDO_MOSTLY_TRANSFER, EXTENDO_ARM_TRANSFER_SPEC, EXTENDO_WRIST_TRANSFER_SPEC, SLIDES_ARM_TRANSFER_SPEC, SLIDES_WRIST_TRANSFER_SPEC, EXTENDO_CLAW_CLOSED, CLAW_OPEN, SLIDES_IN, null, SWIVEL_STRAIGHT, new LinkedState(FULL_TRANSFER_AUTO1_5, 1000));
    public static HobbesState FULL_TRANSFER_AUTO_52 = new HobbesState(EXTENDO_IN, EXTENDO_ARM_SPECIMEN_PICKUP, EXTENDO_WRIST_SPECIMEN_PICKUP, SLIDES_ARM_TRANSFER_SPEC, SLIDES_WRIST_TRANSFER_SPEC, CLAW_ALMOST_CLOSED, CLAW_OPEN, SLIDES_SPECIMEN_PICKED_UP, null, SWIVEL_STRAIGHT_SPEC, new LinkedState(FULL_TRANSFER_AUTO_5, 500));
    public static HobbesState FULL_TRANSFER_AUTO = new HobbesState(EXTENDO_IN, EXTENDO_ARM_SPECIMEN_PICKUP, EXTENDO_WRIST_SPECIMEN_PICKUP, SLIDES_ARM_TRANSFER_SPEC, SLIDES_WRIST_TRANSFER_SPEC, EXTENDO_CLAW_CLOSED, CLAW_OPEN, SLIDES_SPECIMEN_PICKED_UP, null, SWIVEL_STRAIGHT_SPEC, new LinkedState(FULL_TRANSFER_AUTO_52, 100));


    public static HobbesState FULL_TRANSFER5 = new HobbesState(EXTENDO_MOSTLY_TRANSFER, EXTENDO_ARM_TRANSFER, EXTENDO_WRIST_TRANSFER, SLIDES_ARM_TRANSFER, SLIDES_WRIST_TRANSFER, CLAW_OPEN, CLAW_CLOSED, SLIDES_IN, null, SWIVEL_STRAIGHT, null);
    public static HobbesState FULL_TRANSFER4 = new HobbesState(EXTENDO_TRANSFER, EXTENDO_ARM_TRANSFER, EXTENDO_WRIST_TRANSFER, SLIDES_ARM_TRANSFER, SLIDES_WRIST_TRANSFER, CLAW_OPEN, CLAW_CLOSED, SLIDES_IN, null, SWIVEL_STRAIGHT, new LinkedState(FULL_TRANSFER5, 50));
    public static HobbesState FULL_TRANSFER3 = new HobbesState(EXTENDO_TRANSFER, EXTENDO_ARM_TRANSFER, EXTENDO_WRIST_TRANSFER, SLIDES_ARM_TRANSFER, SLIDES_WRIST_TRANSFER, EXTENDO_CLAW_CLOSED, CLAW_CLOSED, SLIDES_IN, null, SWIVEL_STRAIGHT, new LinkedState(FULL_TRANSFER4, 50));
    public static HobbesState FULL_TRANSFER2 = new HobbesState(EXTENDO_TRANSFER, EXTENDO_ARM_TRANSFER, EXTENDO_WRIST_TRANSFER, SLIDES_ARM_TRANSFER, SLIDES_WRIST_TRANSFER, EXTENDO_CLAW_CLOSED, CLAW_OPEN, SLIDES_IN, null, SWIVEL_STRAIGHT, new LinkedState(FULL_TRANSFER3, 200));
    public static HobbesState FULL_TRANSFER1_5 = new HobbesState(EXTENDO_MOSTLY_TRANSFER, EXTENDO_ARM_TRANSFER, EXTENDO_WRIST_TRANSFER, SLIDES_ARM_TRANSFER, SLIDES_WRIST_TRANSFER, CLAW_ALMOST_CLOSED, CLAW_OPEN, SLIDES_IN, null, SWIVEL_STRAIGHT, new LinkedState(FULL_TRANSFER2, 800));
    public static HobbesState FULL_TRANSFER = new HobbesState(EXTENDO_MOSTLY_TRANSFER, EXTENDO_ARM_TRANSFER, EXTENDO_WRIST_TRANSFER, SLIDES_ARM_TRANSFER, SLIDES_WRIST_TRANSFER, EXTENDO_CLAW_CLOSED, CLAW_OPEN, SLIDES_IN, null, SWIVEL_STRAIGHT, new LinkedState(FULL_TRANSFER1_5, 250));

    public static HobbesState FULL_TRANSFER_IP5 = new HobbesState(EXTENDO_MOSTLY_TRANSFER_IP, EXTENDO_ARM_TRANSFER, EXTENDO_WRIST_TRANSFER, SLIDES_ARM_TRANSFER_IP, SLIDES_WRIST_TRANSFER, EXTENDO_CLAW_CLOSED, CLAW_CLOSED, SLIDES_IN, null, SWIVEL_TRANSFER_IP, null);
    public static HobbesState FULL_TRANSFER_IP4 = new HobbesState(EXTENDO_TRANSFER_IP, EXTENDO_ARM_TRANSFER, EXTENDO_WRIST_TRANSFER, SLIDES_ARM_TRANSFER_IP, SLIDES_WRIST_TRANSFER, EXTENDO_CLAW_CLOSED, CLAW_CLOSED, SLIDES_IN, null, SWIVEL_TRANSFER_IP, new LinkedState(FULL_TRANSFER_IP5, 100));
    public static HobbesState FULL_TRANSFER_IP3 = new HobbesState(EXTENDO_TRANSFER_IP, EXTENDO_ARM_TRANSFER, EXTENDO_WRIST_TRANSFER, SLIDES_ARM_TRANSFER_IP, SLIDES_WRIST_TRANSFER, EXTENDO_CLAW_IP, CLAW_CLOSED, SLIDES_IN, null, SWIVEL_TRANSFER_IP, new LinkedState(FULL_TRANSFER_IP4, 100));
    ...
    public static HobbesState FULL_TRANSFER_IP1_5 = new HobbesState(EXTENDO_MOSTLY_TRANSFER_IP, EXTENDO_ARM_TRANSFER, EXTENDO_WRIST_TRANSFER, SLIDES_ARM_TRANSFER_IP, SLIDES_WRIST_TRANSFER, EXTENDO_CLAW_IP, CLAW_OPEN, SLIDES_IN, null, SWIVEL_TRANSFER_IP, new LinkedState(FULL_TRANSFER_IP2, 800));
    public static HobbesState FULL_TRANSFER_IP = new HobbesState(EXTENDO_MOSTLY_TRANSFER_IP, EXTENDO_ARM_TRANSFER, EXTENDO_WRIST_TRANSFER, SLIDES_ARM_TRANSFER_IP, SLIDES_WRIST_TRANSFER, EXTENDO_CLAW_IP, CLAW_OPEN, SLIDES_IN, null, SWIVEL_TRANSFER_IP, new LinkedState(FULL_TRANSFER_IP1_5, 250));
    ...
    public static HobbesState SLIDES_DEPOSIT2 = new HobbesState(EXTENDO_IN, null, EXTENDO_WRIST_INTAKE_FLAT,
            null, SLIDES_WRIST_HALF, null, null, null,  null, null,new LinkedState(SLIDES_DEPOSIT3, 850));
    public static HobbesState SLIDES_DEPOSIT = new HobbesState(EXTENDO_IN, null, EXTENDO_WRIST_INTAKE_FLAT, null, null, null, null,
    ...
    public static HobbesState TELE_SPECIMEN_PICKUP = new HobbesState(EXTENDO_IN, EXTENDO_ARM_SPECIMEN_PICKUP, EXTENDO_WRIST_SPECIMEN_PICKUP, SLIDES_ARM_ABOVE_TRANSFER,
            ...
            null,SWIVEL_STRAIGHT_SPEC,null);
    ...
    public static HobbesState SAMPLE_SWEEP_DOWN = new HobbesState(EXTENDO_OUT_FULL, EXTENDO_ARM_PUSH_DOWN,
            EXTENDO_WRIST_INTAKE_FLAT, SLIDES_ARM_ABOVE_TRANSFER, SLIDES_WRIST_TRANSFER, null, null, null,  null,null,null);
    ...
    public static HobbesState OUTTAKE = new HobbesState(null, EXTENDO_ARM_OUTAKE, EXTENDO_WRIST_OUTAKE,
            null, null, INTAKE_REVERSE, null, null, null,null,null);
