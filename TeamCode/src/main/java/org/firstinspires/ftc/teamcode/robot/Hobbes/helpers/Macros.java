...
public class Macros {
    ...
    public static HobbesState EXTENDO_CLAW_BEFORE_PICKUP = new HobbesState(null, EXTENDO_ARM_PICKUP, EXTENDO_WRIST_PICKUP, null, null, EXTENDO_CLAW_OPEN, null, null, null,null, new LinkedState(EXTENDO_CLAW_BEFORE_PICKUP2, 20));
    ...
    public static HobbesState EXTENDO_CLAW_BEFORE_PICKUP_INSIDE = new HobbesState(null, EXTENDO_ARM_PICKUP, EXTENDO_WRIST_PICKUP, null, null, EXTENDO_CLAW_CLOSED, null, null, null,null, new LinkedState(EXTENDO_CLAW_BEFORE_PICKUP_INSIDE2, 100));
    ...
    public static HobbesState FULL_TRANSFER_AUTO5 = new HobbesState(EXTENDO_MOSTLY_TRANSFER, EXTENDO_ARM_TRANSFER_SPEC, EXTENDO_WRIST_TRANSFER_SPEC, SLIDES_ARM_TRANSFER_SPEC, SLIDES_WRIST_TRANSFER_SPEC, CLAW_OPEN, CLAW_CLOSED, SLIDES_IN, null, SWIVEL_STRAIGHT_SPEC, new LinkedState(STUPID_SPECIMEN_TO_DEPOSIT_NEW, 100));
    public static HobbesState FULL_TRANSFER_AUTO4 = new HobbesState(EXTENDO_IN, EXTENDO_ARM_TRANSFER_SPEC, EXTENDO_WRIST_TRANSFER_SPEC, SLIDES_ARM_TRANSFER_SPEC, SLIDES_WRIST_TRANSFER_SPEC, CLAW_OPEN, CLAW_CLOSED, SLIDES_IN, null, SWIVEL_STRAIGHT_SPEC, new LinkedState(FULL_TRANSFER_AUTO5, 100));
    public static HobbesState FULL_TRANSFER_AUTO3 = new HobbesState(EXTENDO_IN, EXTENDO_ARM_TRANSFER_SPEC, EXTENDO_WRIST_TRANSFER_SPEC, SLIDES_ARM_TRANSFER_SPEC, SLIDES_WRIST_TRANSFER_SPEC, EXTENDO_CLAW_CLOSED, CLAW_CLOSED, SLIDES_IN, null, SWIVEL_STRAIGHT_SPEC, new LinkedState(FULL_TRANSFER_AUTO4, 100));
    public static HobbesState FULL_TRANSFER_AUTO2 = new HobbesState(EXTENDO_IN, EXTENDO_ARM_TRANSFER_SPEC, EXTENDO_WRIST_TRANSFER_SPEC, SLIDES_ARM_TRANSFER_SPEC, SLIDES_WRIST_TRANSFER_SPEC, EXTENDO_CLAW_CLOSED, CLAW_OPEN, SLIDES_IN, null, SWIVEL_STRAIGHT_SPEC, new LinkedState(FULL_TRANSFER_AUTO3, 200));
    ...
    public static HobbesState FULL_TRANSFER_AUTO_52 = new HobbesState(EXTENDO_IN, EXTENDO_ARM_SPECIMEN_PICKUP, EXTENDO_WRIST_SPECIMEN_PICKED_UP, SLIDES_ARM_TRANSFER_SPEC, SLIDES_WRIST_TRANSFER_SPEC, CLAW_ALMOST_CLOSED, CLAW_OPEN, SLIDES_IN, null, SWIVEL_STRAIGHT, new LinkedState(FULL_TRANSFER_AUTO_5, 300));
    public static HobbesState FULL_TRANSFER_AUTO1 = new HobbesState(EXTENDO_IN, EXTENDO_ARM_SPECIMEN_PICKUP, EXTENDO_WRIST_SPECIMEN_PICKED_UP, SLIDES_ARM_TRANSFER_SPEC, SLIDES_WRIST_TRANSFER_SPEC, EXTENDO_CLAW_CLOSED, CLAW_OPEN, SLIDES_IN, null, SWIVEL_STRAIGHT, new LinkedState(FULL_TRANSFER_AUTO_52, 150));
    public static HobbesState FULL_TRANSFER_AUTO = new HobbesState(EXTENDO_IN, EXTENDO_ARM_SPECIMEN_PICKUP, EXTENDO_WRIST_SPECIMEN_PICKUP, SLIDES_ARM_TRANSFER_SPEC, SLIDES_WRIST_TRANSFER_SPEC, EXTENDO_CLAW_CLOSED, CLAW_OPEN, SLIDES_IN, null, SWIVEL_STRAIGHT, new LinkedState(FULL_TRANSFER_AUTO1, 50));


    public static HobbesState FULL_TRANSFER5 = new HobbesState(EXTENDO_MOSTLY_TRANSFER, EXTENDO_ARM_TRANSFER, EXTENDO_WRIST_TRANSFER, SLIDES_ARM_TRANSFER, SLIDES_WRIST_TRANSFER, CLAW_OPEN, CLAW_CLOSED, SLIDES_IN, null, SWIVEL_STRAIGHT_SPEC, null);
    public static HobbesState FULL_TRANSFER4 = new HobbesState(EXTENDO_TRANSFER, EXTENDO_ARM_TRANSFER, EXTENDO_WRIST_TRANSFER, SLIDES_ARM_TRANSFER, SLIDES_WRIST_TRANSFER, CLAW_OPEN, CLAW_CLOSED, SLIDES_IN, null, SWIVEL_STRAIGHT_SPEC, new LinkedState(FULL_TRANSFER5, 50));
    public static HobbesState FULL_TRANSFER3 = new HobbesState(EXTENDO_TRANSFER, EXTENDO_ARM_TRANSFER, EXTENDO_WRIST_TRANSFER, SLIDES_ARM_TRANSFER, SLIDES_WRIST_TRANSFER, EXTENDO_CLAW_CLOSED, CLAW_CLOSED, SLIDES_IN, null, SWIVEL_STRAIGHT_SPEC, new LinkedState(FULL_TRANSFER4, 50));
    public static HobbesState FULL_TRANSFER2 = new HobbesState(EXTENDO_TRANSFER, EXTENDO_ARM_TRANSFER, EXTENDO_WRIST_TRANSFER, SLIDES_ARM_TRANSFER, SLIDES_WRIST_TRANSFER, EXTENDO_CLAW_CLOSED, CLAW_OPEN, SLIDES_IN, null, SWIVEL_STRAIGHT_SPEC, new LinkedState(FULL_TRANSFER3, 400));
    public static HobbesState FULL_TRANSFER1_5 = new HobbesState(EXTENDO_MOSTLY_TRANSFER, EXTENDO_ARM_TRANSFER, EXTENDO_WRIST_TRANSFER, SLIDES_ARM_TRANSFER, SLIDES_WRIST_TRANSFER, CLAW_ALMOST_CLOSED, CLAW_OPEN, SLIDES_IN, null, SWIVEL_STRAIGHT_SPEC, new LinkedState(FULL_TRANSFER2, 250));
    public static HobbesState FULL_TRANSFER5_5 = new HobbesState(EXTENDO_MOSTLY_TRANSFER, EXTENDO_ARM_TRANSFER, EXTENDO_WRIST_TRANSFER, SLIDES_ARM_TRANSFER, SLIDES_WRIST_TRANSFER, EXTENDO_CLAW_CLOSED, CLAW_OPEN, SLIDES_IN, null, SWIVEL_STRAIGHT_SPEC, new LinkedState(FULL_TRANSFER1_5, 250));
    public static HobbesState FULL_TRANSFER = new HobbesState(EXTENDO_MOSTLY_TRANSFER, EXTENDO_ARM_TRANSFER, EXTENDO_WRIST_TRANSFER, SLIDES_ARM_TRANSFER, SLIDES_WRIST_TRANSFER, EXTENDO_CLAW_CLOSED, CLAW_OPEN, SLIDES_IN, null, SWIVEL_STRAIGHT_SPEC, new LinkedState(FULL_TRANSFER5_5, 250));
    ...
    public static HobbesState SLIDES_DEPOSIT2 = new HobbesState(EXTENDO_IN, null, EXTENDO_WRIST_INTAKE_FLAT,
            null, SLIDES_WRIST_HALF, null, null, null,  null, null,new LinkedState(SLIDES_DEPOSIT3, 450));
    public static HobbesState SLIDES_DEPOSIT = new HobbesState(EXTENDO_IN, null, EXTENDO_WRIST_INTAKE_FLAT, null, null, null, null,
            SLIDES_OUT_TOP_SAMPLE,  null,null,new LinkedState(SLIDES_DEPOSIT2, 250));
    ...
    public static HobbesState TELE_SPECIMEN_PICKUP = new HobbesState(EXTENDO_IN, EXTENDO_ARM_SPECIMEN_PICKUP, EXTENDO_WRIST_SPECIMEN_PICKUP,
            ...
            null,SWIVEL_TRANSFER,null);
    public static HobbesState SPEC_ALMOST_PICKUP = new HobbesState(EXTENDO_IN, EXTENDO_ARM_SPECIMEN_PICKUP+.05, EXTENDO_WRIST_SPECIMEN_PICKUP,
            SLIDES_ARM_ABOVE_TRANSFER, SLIDES_WRIST_TRANSFER, EXTENDO_CLAW_OPEN, CLAW_OPEN, SLIDES_IN,
            null,SWIVEL_TRANSFER,null);
