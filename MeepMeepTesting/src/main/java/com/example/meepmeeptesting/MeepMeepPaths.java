...
public class MeepMeepPaths {
        public static void main(String[] args) {
                ...
                TrajectoryActionBuilder a2 = a1.endTrajectory().fresh().setTangent(0)
                        .splineTo(new Vector2d(-25, 24), PI * 5 / 6);
                ...
                TrajectoryActionBuilder s2 = a3.endTrajectory().fresh()
                        .setTangent(PI)
                        .splineToLinearHeading(new Pose2d(-25, 33, PI*5/6), PI * 5 / 6);
                ...
                TrajectoryActionBuilder s4_5 = s4.endTrajectory().fresh()
                        .setTangent(0).splineToLinearHeading(new Pose2d(-10, 30, 2*PI/16),
                                0,  null, new ProfileAccelConstraint(-80, 20))
                        .setTangent(0)
                        .splineToSplineHeading(new Pose2d(4, 29, 0), 0);

                TrajectoryActionBuilder a5 = s4_5.endTrajectory().fresh().setTangent(PI)
